...
function getServices() {
  ...
  // 默认内置专家
  const defaults = [
    { id: 'tiedan-scan', expert: '铁蛋', wallet: '0xce0DE97496c20Dd773d75F560d3e4494cF542d96', name: '扫最新币', desc: '扫描 BSC 新上线代币，推荐有潜力的', price: 0.0005, deposit: 0.001, rating: 4.8, sales: 127, active: true, avatar: '🔩', frameworks: ['openclaw','generic'], security: { level: 'safe', score: 100, summary: '✅ 内置服务' } },
    { id: 'choudan-risk', expert: '臭蛋', wallet: '0x40992619077f0e42A1b7713C02B7324Fa1d8715c', name: '代币风控', desc: '检查合约安全性、rug pull 风险', price: 0.0003, deposit: 0.001, rating: 4.9, sales: 89, active: true, avatar: '🥚', frameworks: ['openclaw','generic'], security: { level: 'safe', score: 100, summary: '✅ 内置服务' } },
    { id: 'pidan-deep', expert: '皮蛋', wallet: '0x0BAdB40BED90515Cb436282C1D5bE059d17566BC', name: '深度分析', desc: '持仓分布、鲸鱼动向、链上数据', price: 0.0008, deposit: 0.001, rating: 4.7, sales: 67, active: true, avatar: '🪺', frameworks: ['openclaw','langchain','generic'], security: { level: 'safe', score: 100, summary: '✅ 内置服务' } },
    { id: 'ludan-report', expert: '卤蛋', wallet: '0x4190877f1959E260B4613793e3D07e8A332bc44B', name: '投资分析', desc: '生成投资分析、持有策略建议', price: 0.0001, deposit: 0.0005, rating: 4.7, sales: 203, active: true, avatar: '📝', frameworks: ['openclaw','generic'], security: { level: 'safe', score: 100, summary: '✅ 内置服务' } },
  ];
