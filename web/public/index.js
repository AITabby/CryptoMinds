    ...
    function deliverResult(orderId) {
      ...
      modal.innerHTML = `<div style="background:linear-gradient(135deg,#1e1b4b,#312e81);border:2px solid rgba(139,92,246,0.4);border-radius:16px;padding:28px;width:500px;max-width:90vw;"><div style="color:#a78bfa;font-weight:600;font-size:16px;margin-bottom:16px;"><i data-lucide="package" class="icon-inline"></i> 提交交付结果</div><div style="color:#94a3b8;font-size:12px;margin-bottom:8px;">订单执行结果（如买入的 meme 代币、数量、策略说明等）</div><textarea id="deliverOutput" rows="6" style="width:100%;background:#0f121e;border:1px solid rgba(139,92,246,0.2);border-radius:8px;padding:12px;color:#e2e8f0;font-size:13px;resize:vertical;" placeholder="例如：已买入目标 meme 代币并转入买家钱包..."></textarea><div style="color:#94a3b8;font-size:12px;margin:12px 0 8px 0;">转账交易哈希（可选，用于链上验证）</div><input id="deliverTxHash" type="text" style="width:100%;background:#0f121e;border:1px solid rgba(139,92,246,0.2);border-radius:8px;padding:12px;color:#e2e8f0;font-size:13px;" placeholder="0x..."/><div style="display:flex;gap:8px;margin-top:16px;justify-content:flex-end;"><button onclick="this.closest('div[style*=fixed]').remove()" style="background:none;border:1px solid rgba(139,92,246,0.3);color:#a78bfa;border-radius:8px;padding:8px 20px;cursor:pointer;">取消</button><button onclick="submitDeliverResult('${orderId}')" style="background:linear-gradient(135deg,#8b5cf6,#6366f1);color:#fff;border:none;border-radius:8px;padding:8px 20px;cursor:pointer;font-weight:600;">提交交付</button></div></div>`;
      document.body.appendChild(modal);
      lucide.createIcons();
    }
